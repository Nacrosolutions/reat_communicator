...
const Welcome = () => {
  ...
  <StyledButton>
   ...
   <Button primary="orangeLight" radius="1rem" style={{color:"white",fontWeight:500,fontSize:"14px",border:"0px solid"}} className="table-hover"><span style={{fontSize:"16px"}}>Register <FaLongArrowAltRight/> </span></Button>
